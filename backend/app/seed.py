...
DEMO_HALLS = [
    ("Большой зал", "До 200 человек, сцена, проектор", 35000),
    ("Малый зал", "До 50 человек, камерные мероприятия", 15000),
    ("Конференц-зал", "До 30 человек, переговорная", 8000),
]
...
async def seed():
    async with AsyncSessionLocal() as db:
        ...
        hall_big, hall_small, hall_conf = halls
